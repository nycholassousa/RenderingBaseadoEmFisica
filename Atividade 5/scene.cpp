...
struct CheckIntersection
{
	...
	CheckIntersection(const Ray &ray,
					  IntersectionRecord &intersection_record) : ray(ray)
	{
...
void Scene::load(void)
{
	...
	Material m4 = {glm::vec3{12.0f, 12.0f, 12.0f}, glm::vec3{0.78f}, 0.0f, Material::diffuse, nullptr, Material::UNIFORM}; //luz
	...
	loadObject("objects/buda.obj", 7, glm::vec3{0.09f, 0.0f, 0.0f});
	loadObject("objects/buda.obj", 11, glm::vec3{0.0f, 0.0f, 0.0f});
	loadObject("objects/buda.obj", 12, glm::vec3{-0.09f, 0.0f, 0.0f});
